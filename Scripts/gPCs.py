...
# Output: association
OUTPUT_ASSOC_ALL = os.path.join(BASE_DIR, "Parallel_Association_All_SNVs_QC_LD_PCsOnly.xlsx")
OUTPUT_ASSOC_SELECTED = os.path.join(BASE_DIR, "Parallel_Association_Selected_SNVs_QC_LD_PCsOnly.xlsx")

# Output: RF
OUTPUT_RF_ALL = os.path.join(BASE_DIR, "Parallel_RF_All_SNVs_QC_LD_PCsOnly.xlsx")
OUTPUT_RF_SELECTED = os.path.join(BASE_DIR, "Parallel_RF_Selected_SNVs_QC_LD_PCsOnly.xlsx")

# Output: QC
OUTPUT_QC_XLSX = os.path.join(BASE_DIR, "Parallel_QC_Summary_PCsOnly.xlsx")
